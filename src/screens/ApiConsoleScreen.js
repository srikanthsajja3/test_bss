...
const API_ENDPOINTS = [
  ...
  { id: '2.3', name: 'POST /partner.php (Create Partner)', method: 'POST', module: '2. Partner Management', payload: JSON.stringify({ partner_name: 'Metro Fiber', company_name: 'Metro Fiber Networks Ltd', partner_mobile: '9876543210', partner_email: 'admin@metrofiber.com', partner_region: 'South Zone', login: { username: 'oper1', password: 'oper1', role: 'operator' }, internet_mapping: { internet_base_url: 'https://radius.vrplay.in', internet_token: 'sdfghjkluytresa', internet_partner_id: '222', internet_branch_id: '111' } }, null, 2), action: (p) => OneBssApi.createPartner(p ? JSON.parse(p) : {}) },
